...
class MachinesControllerTest < ActionController::TestCase
  ...
  test "should create machine" do
    assert_difference('Machine.count') do
      post :create, machine: { name: @machine.name, workdays: @machine.workdays, workhours: @machine.workhours }
    end
  ...
  test "should update machine" do
    patch :update, id: @machine, machine: { name: @machine.name, workdays: @machine.workdays, workhours: @machine.workhours }
    assert_redirected_to machine_path(assigns(:machine))
  end
